import shakespeareHead from "/shakespeare-glasses.png";
  ...
  return (
    <header className="navbar bg-secondary">
      <a
        ...
        target="_blank"
        className="navbar-start flex h-full gap-1"
      >
        <img
          src={shakespeareHead}
          className="logo h-14"
        ...
        />
      <h1 className="text-4xl tracking-wider text-slate-900 ">Search</h1>
      </a>
